...
var users = [
    ...
    {login: 'Johhny1', password: 'lubie_placki'},
    {login: 'Johhny2', password: 'lubie_placki'},
];
...
developer.otherInfo.skills.frameworks
...
workers[1].experience[0].company
workers[1].experience[1].company
workers[1].experience[2].company